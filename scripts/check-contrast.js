...
export const pairs = [
  ...
  { filter: "pro", label: "代码注释", foreground: "#7a757c", background: "#221f22", minimum: 3.5 },
  ...
  { filter: "light", label: "正文", foreground: "#343434", background: "#faf8f2", minimum: 4.5 },
  { filter: "light", label: "链接", foreground: "#0f6478", background: "#faf8f2", minimum: 4.5 },
  { filter: "light", label: "图标", foreground: "#606060", background: "#f0eee7", minimum: 3 },
  { filter: "light", label: "高亮文本", foreground: "#343434", background: "#f7e7b3", minimum: 4.5 },
  { filter: "light", label: "代码注释", foreground: "#77736c", background: "#ebe8df", minimum: 3 },
  { filter: "light", label: "代码字符串", foreground: "#8a5200", background: "#ebe8df", minimum: 4.5 },
  { filter: "light", label: "代码属性", foreground: "#0f6478", background: "#ebe8df", minimum: 4.5 },
  { filter: "light", label: "代码数值", foreground: "#684cae", background: "#ebe8df", minimum: 4.5 },
  { filter: "light", label: "代码关键字", foreground: "#b82f5b", background: "#ebe8df", minimum: 4.5 },
  { filter: "light", label: "代码函数", foreground: "#126b44", background: "#ebe8df", minimum: 4.5 },
  { filter: "light", label: "代码运算符", foreground: "#a93355", background: "#ebe8df", minimum: 4.5 },
  { filter: "light", label: "行号", foreground: "#77736c", background: "#f0eee7", minimum: 3 },
  { filter: "light", label: "选区文字", foreground: "#343434", background: "#d8edf0", minimum: 4.5 },
  { filter: "light", label: "代码块边框", foreground: "#c8c2b2", background: "#ebe8df", minimum: 1.35 },
