...
const checks = [
  ...
  ["深色块引用边框使用 Monokai 黄色", /body\.theme-dark[\s\S]*?--monokai-blockquote-border:\s*#\{\$color-dark-blockquote-border\};/],
  ...
  ["深色 Callout 使用语义背景变量", /body\.theme-dark[\s\S]*?--monokai-callout-note-bg:\s*rgb\(102 217 239 \/ 12%\);/],
